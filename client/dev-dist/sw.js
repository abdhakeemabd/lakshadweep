...
define(['./workbox-36e57b92'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\/(?:homepage-api|vendor-api|api|slot-api|package-api|customer-api|category-api|setting-api)\/.*/i, new workbox.NetworkFirst({
    "cacheName": "api-cache",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 200,
