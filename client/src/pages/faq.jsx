    ...
    <section>
      <div className="container mx-auto px-3 py-10 lg:py-20">
        <div className="grid grid-cols-12 justify-content-center">
          <div className="col-span-12  md:text-center mb-8 lg:mb-12" data-aos="fade-up" data-aos-delay="400">
            <h1 className="font-poppins font-medium text-[clamp(34px,5vw,60px)] md:text-center leading-[85%] tracking-[-0.06em] mb-4 lg:mb-5">Frequently Asked Questions</h1>
          ...
          <div className="col-span-12 max-w-[900px] mx-auto space-y-4">
            {accordionData.map((item, index) => (
              <div key={index} className="border border-[#F1F2F9] rounded-[16px] p-[1.4rem] align-center overflow-hidden hover:translate-y-[-4px] shadow-[0_4px_10px_rgba(13,72,168,0.2)] duration-300" data-aos="fade-up" data-aos-delay="400">
                <button onClick={() => toggleAccordion(index)} className="w-full flex justify-between items-center text-left font-medium  transition">
                  ...
                  <span className={`transform transition-transform duration-300 min-w-[36px] ${openIndex === index ? "rotate-180" : ""}`}>
                    <img className='bg-[#F1F2F9] p-3 rounded-full min-w-[36px]' src={Arrow} alt="Arrow" />
                  </span>
                </button>
