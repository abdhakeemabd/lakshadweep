    ...
    <Listbox value={value} onChange={onChange}>
      {({ open }) => (
        <div className="relative">
          <ListboxButton className="relative w-full cursor-pointer rounded-xl border border-gray-200 bg-white text-left focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all h-[45px] flex items-center px-4">
          ...
          <Transition
            ...
            afterLeave={() => setQuery('')}
          >
            <ListboxOptions static className="absolute z-[110] mt-1 max-h-72 w-full min-w-[220px] rounded-xl bg-white py-1 text-base shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm border border-gray-100">
              <div className="p-3 sticky top-0 bg-white border-b border-gray-50 z-10" onClick={(e) => e.stopPropagation()}>
                <div className="relative">
                  ...
                  <input
                    type="text"
                    autoFocus
                    className="w-full rounded-lg border border-gray-100 py-2 pl-9 pr-3 text-sm leading-5 text-gray-900 focus:border-orange-500 outline-none transition-all"
