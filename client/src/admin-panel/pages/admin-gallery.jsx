      ...
      <div className="container-fluid mx-auto pr-3">
        <div className="flex gap-5">
          ...
          <div className=" w-full pt-3">
            ...
            <div className="card relative flex flex-col break-words bg-white bg-clip-border rounded-[1.25rem] shadow-[3px_4px_20px_0px_#0000000F] border-0 my-3  py-3 px-3">
