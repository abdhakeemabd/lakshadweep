        ...
        function VendorList() {
          ...
          const handleDelete = async (vendorId) => {
            ...
            const deleteEndpoints = [
              ...
              { url: `/vendor-api/api/vendor/vendors/${vendorId}/`, method: 'DELETE' },
              { url: `/vendor-api/vendor-delete/${vendorId}/`, method: 'DELETE' },
              { url: `/vendor-api/api/vendor/vendor-delete/${vendorId}/`, method: 'DELETE' },
              { url: `/vendor-api/vendor/delete-vendor/${vendorId}/`, method: 'DELETE' },
              { url: `/vendor-api/api/vendor/delete-vendor/${vendorId}/`, method: 'DELETE' },
          ...
          const handleDeactivate = async (vendorId) => {
            ...
            try {
              let success = false;
              const endpoints = [
                `/vendor-api/vendor/${vendorId}/deactivate/`,
                `/vendor-api/api/vendor/vendors/${vendorId}/deactivate/`,
                `/vendor-api/vendor/vendor-deactivate/${vendorId}/`,
                `/vendor-api/api/vendor/vendor-deactivate/${vendorId}/`,
                `/vendor-api/vendor/deactivate-vendor/${vendorId}/`,
                `/vendor-api/api/vendor/deactivate-vendor/${vendorId}/`
              ];
          ...
          const handleActivate = async (vendorId) => {
            ...
            try {
                let success = false;
                const endpoints = [
                  `/vendor-api/vendor/${vendorId}/activate/`,
                  `/vendor-api/api/vendor/vendors/${vendorId}/activate/`,
                  `/vendor-api/vendor/vendor-activate/${vendorId}/`,
                  `/vendor-api/api/vendor/vendor-activate/${vendorId}/`,
                  `/vendor-api/vendor/activate-vendor/${vendorId}/`,
                  `/vendor-api/api/vendor/activate-vendor/${vendorId}/`
                ];
                for (const endpoint of endpoints) {
                  const response = await fetch(endpoint, {
                    method: 'POST',
                ...
                if (success) {
                  // If you have a swal-delete for activate, you can show it here
                  showDeleteSuccess('Vendor activated successfully'); 
                  // or ideally: showActivateSuccess('Vendor');
                  fetchVendors();
                } else {
                }
            } catch (err) {
