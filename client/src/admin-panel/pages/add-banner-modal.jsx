...
function AddBannerModal() {
  ...
  return (
    <>
      ...
      <dialog ref={dialogRef} id="add-banner-modal" aria-labelledby="add-banner-modal-title" className="fixed inset-0 z-[100] w-full h-full bg-transparent m-0 p-0 max-w-none max-h-none backdrop:bg-black/50 backdrop:backdrop-blur-sm py-3 md:py-7">
