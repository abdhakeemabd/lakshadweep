...
function AddBannerModal({ onSuccess }) {
      ...
      if (response.ok) {
        ...
        if (contentType && contentType.includes("application/json")) {
          ...
          if (categoriesList.length === 0) {
            console.warn('No categories found for activities:', data);
          }
      ...
      if (response.ok) {
        ...
        if (contentType && contentType.includes("application/json")) {
          ...
          if (typeof errors === 'object' && !Array.isArray(errors)) {
            ...
            errorMsg = errData.message || 'Failed to add banner';
          }
              ...
              <div className="modal-body px-6 py-4 bg-white">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-5">
                  <div className="col-span-12 mb-2">
                    ...
                    <input  type="text"  id="title" className="w-full h-[45px] rounded-xl border border-gray-200 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-poppins text-gray-900" placeholder="Enter banner title" value={formData.title} onChange={(e) => handleSelectChange('title', e.target.value)} required/>
                  </div>
                  ...
                  <div className="col-span-12 mb-2">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-[#989898] text-[12px] font-poppins break-all">{fileName}</span>
                    </div>
