                ...
                <form action="">
                  <div className="grid grid-cols-12 gap-5 lg:gap-x-6 lg:gap-y-5">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                      ...
                      <textarea id="vendor_description" className="w-full border rounded-[10px] px-3 py-2 text-[14px] border-0 focus:outline-none  bg-[#f5f5f5] text-[#414141] min-h-[100px]" placeholder='Enter Description' ></textarea>
                    </div>
                  </div>
                </form>
              </div>
