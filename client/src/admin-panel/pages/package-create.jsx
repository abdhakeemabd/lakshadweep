        ...
        <form action="">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div className="col-span-1 md:col-span-6 mb-3">
              ...
              <textarea type="text" id="activity_info" name="activity_info" className="mt-1 block w-full bg-[#f5f5f5] p-[8px_15px] min-h-[180px] rounded-[10px]" />
            </div>
            <div className="col-span-1 md:col-span-6 mb-3">
              ...
              <textarea type="text" id="whats_included" name="whats_included" className="mt-1 block w-full bg-[#f5f5f5] p-[8px_15px] min-h-[180px] rounded-[10px]" />
            </div>
            <div className="col-span-1 md:col-span-6 mb-3">
              ...
              <textarea type="text" id="whats_excluded" name="whats_excluded" className="mt-1 block w-full bg-[#f5f5f5] p-[8px_15px] min-h-[180px] rounded-[10px]" />
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            <div className="col-span-1 md:col-span-6 lg:col-span-4 mb-3">
              ...
              <input type="text" id="package_badge" name="package_badge" className="mt-1 block w-full bg-[#f5f5f5] p-[8px_15px] min-h-[42px] rounded-[10px]" />
            </div>
            <div className="col-span-1 md:col-span-6 lg:col-span-4 mb-3">
              <label htmlFor="package_bookings_badge" className="block text-[13px] font-medium text-[#3D3D3D] mb-3">Package Bookings Badge </label>
              <input type="text" id="package_bookings_badge" name="package_bookings_badge" className="mt-1 block w-full bg-[#f5f5f5] p-[8px_15px] min-h-[42px] rounded-[10px]" />
            </div>
            <div className="col-span-1 md:col-span-6 lg:col-span-4 mb-3">
              <label htmlFor="duration" className="block text-[13px] font-medium text-[#3D3D3D] mb-3">Duration  </label>
              <input type="text" id="duration" name="duration" className="mt-1 block w-full bg-[#f5f5f5] p-[8px_15px] min-h-[42px] rounded-[10px]" />
            </div>
            <div className="col-span-1 md:col-span-6 lg:col-span-4 mb-3">
              ...
              <input type="text" id="default_price" name="default_price" className="mt-1 block w-full bg-[#f5f5f5] p-[8px_15px] min-h-[42px] rounded-[10px]" />
            </div>
            <div className="col-span-1 md:col-span-6 lg:col-span-4 mb-3">
              ...
              <input type="text" id="commission" name="commission" className="mt-1 block w-full bg-[#f5f5f5] p-[8px_15px] min-h-[42px] rounded-[10px]" />
            </div>
            <div className="col-span-1 md:col-span-6 mb-3">
              <label htmlFor="terms" className="block text-[13px] font-medium text-[#3D3D3D] mb-3">Terms & Conditions</label>
              <textarea type="text" id="terms" name="terms" className="mt-1 block w-full bg-[#f5f5f5] p-[8px_15px] min-h-[180px] rounded-[10px]" />
            </div>
            <div className="col-span-1 md:col-span-6 mb-3">
              ...
              <textarea type="text" id="description" name="description" className="mt-1 block w-full bg-[#f5f5f5] p-[8px_15px] min-h-[180px] rounded-[10px]" />
            </div>
            <div className="col-span-1 md:col-span-6 mb-3">
