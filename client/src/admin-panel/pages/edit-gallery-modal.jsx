...
function EditGalleryModal() {
  ...
  return (
    <>
      ...
      <dialog ref={dialogRef} id="edit-gallery-modal" aria-labelledby="edit-gallery-modal-title" className="fixed inset-0 z-[100] w-full h-full bg-transparent m-0 p-0 max-w-none max-h-none backdrop:bg-black/50 backdrop:backdrop-blur-sm py-3 md:py-7">
