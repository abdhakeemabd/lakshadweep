      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex-1 flex justify-end items-center">
          <div className="relative dropdown-container" ref={dropdownRef}>
            <button onClick={() => setOpen(!open)} className="flex items-center gap-2 px-3 py-1 transition group">
            ...
            {open && (
              <ul className="absolute right-0 mt-2 w-56 rounded-xl bg-white shadow-xl border border-gray-100 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                ...
                <li>
                  <button onClick={handleLogout} className="w-full flex gap-3 items-center px-4 py-3 text-[13px] text-[#dc3545] hover:bg-red-50 transition-colors font-medium">
