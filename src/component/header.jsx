        ...
        <div className="container m-auto px-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden lg:flex justify-end items-center gap-2">
              ...
              <button  command="show-modal" commandfor="dialog" className="min-w-[96px] h-[36px] text-[14px] leading-[11px] font-medium text-white bg-gradient-to-br from-[#20212B] to-[#16171F] rounded-[8px] hover:shadow-lg transition-shadow duration-300">Join now</button>
            </div>
            <div className="flex lg:hidden items-center gap-3">
              <button className="min-w-[80px] h-[32px] text-[12px] font-medium text-white bg-gradient-to-br from-[#20212B] to-[#16171F] rounded-[8px]">Join now</button>
